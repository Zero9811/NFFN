...
<head>
    ...
    <script type="text/javascript">
        ...
        window.onload = function () {
            setIframeHeight(document.getElementById('mainboxId'));
        };
    </script>
...
<div class="app-container">
    <div class="row content-container">
            ...
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown profile">
                        <a href="loginJump.action" class="btn btn-success" role="button">登录 </a>
                    </li>
                </ul>
            </div>
        </nav>
        ...
        <!-- Main Content -->
        <div style="width:1000px;height: 1000px" class="container-fluid col-md-6 col-md-offset-3">
                <iframe id="mainboxId" name="mainbox" frameborder="0" style="width:1000px;height:1000px"></iframe>
